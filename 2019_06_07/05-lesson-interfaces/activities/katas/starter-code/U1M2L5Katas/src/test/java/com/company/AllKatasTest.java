...
public class AllKatasTest {
 ...
 public void testAnalogClock() throws Exception {
     ...
     String failMessage = "Expected com.company.AnalogClock to implement the Clock interface";
     assertTrue(failMessage, analogClock instanceof Clock);

     Class ana = AnalogClock.class;
     failMessage = "Expected com.company.AnalogClock to have diplayTime method";
     assertNotNull(failMessage, ana.getMethod("displayTime"));
     failMessage = "Expected com.company.AnalogClock to have timer method with two integer parameters";
