...
import com.trilogyed.tasker.exception.NoteFoundException;
...
public class ControllerHandler {
    ...
    @ExceptionHandler(value = {NoteFoundException.class})
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<VndErrors> notFoundException(NoteFoundException e, WebRequest request) {
